...
// -------------------------------------------------------------------------
console.log("--- Exemplo 1: Números pares (Básico) ---"); // Nota: O comentário diz "números pares", mas o código abaixo filtra maiores de idade.
...
const perifericosDisponiveis = catalago.filter((item) => {
